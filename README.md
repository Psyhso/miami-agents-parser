...
-Возможности:
1.Собирает информацию о поставщиках, включая: Название компании, Веб-сайт, Контактное лицо (имя и должность), Телефон, Минимальный бюджет, Ссылки на соцсети, URL профиля на PartySlate
